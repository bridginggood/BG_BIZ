...
public class SplashActivity extends Activity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		//Start loading
		SplashLoadingAsyncTask splashLoadingAsyncTask = new SplashLoadingAsyncTask(SplashActivity.this);
	...
	private class SplashLoadingAsyncTask extends AsyncTask<Context, Boolean, Boolean>
	{
		...
		protected Boolean doInBackground(Context... contexts)
		{
			...
			try{
				...
				isLoginSuccess = LoginJSON.doLogin(Business.getBizUsername(), Business.getBizPassword());
		...
		protected void onPostExecute(final Boolean isLoginSuccess)
		{
			...
			if (durationTime <=CONST.SPLASH_DELAY) {
				try {
					...
					Thread.sleep(CONST.SPLASH_DELAY-durationTime);
				} catch (Exception e) {
